...
class GUI(Tkinter.Toplevel):
    ...
    def initWorld(self):
        ...
        self.world[7][1] = ''
        self.world[8][1] = 'G'
        self.exit_location = (0, 1)
        self.doors_opens = {}
        self.doors_opens[3, 1] = [['shellfish', 'no', 'no', 'yes', '8', 'no', 'yes', 'yes', 'no', 'no', 'yes', 'no', 'no', 'no', 'no', 'no', 'no'], 'scorpion', 4, 1]
        self.doors_opens[1, 6] = [['reptile', 'yes', 'no', 'yes', '4', 'no', 'no', 'yes', 'yes', 'no', 'no', 'no', 'no', 'no', 'yes', 'no', 'no'], 'tortoise', 1, 7]
        self.doors_opens[6, 3] = [['shellfish', 'yes', 'no', 'no', '8', 'no', 'no', 'no', 'no', 'no', 'yes', 'yes', 'no', 'no', 'yes', 'no', 'no'], 'octopus', 6, 2]
        self.key_values = {}
        self.key_values[8, 7] = ['reptile', 'yes', 'no', 'yes', '4', 'no', 'no', 'yes', 'yes', 'no', 'no', 'no', 'no', 'no', 'yes', 'no', 'no', 'tortoise']
        self.key_values[3, 8] = ['shellfish', 'yes', 'no', 'no', '8', 'no', 'no', 'no', 'no', 'no', 'yes', 'yes', 'no', 'no', 'yes', 'no', 'no', 'octopus']
        self.wumpus_talk = {}
        self.win = False
        self.lose = False
